...
test_id = "same_loc_diff_m_test_1"
...
# ------------------------------------------------------------------------------
mono = read.table(paste0(data_dir,"output/monolithic_gen.txt"), header = T) 
rich = read.table(paste0(data_dir,"output/richardson_gen.txt"), header = T)
...
# plots 
plot_boxplot_levels(results, m="m", method="solution_policy", 
             filename = paste0(paste0(imgdir,"boxplots.pdf")))

# Non sono veramente interessanti questi plot nel nostro caso
# { 
...
#   plot(m, log(tapply(monolithic$time, monolithic$m, mean)),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(log(results$time)), max(log(results$time))),
#        ylab="", xlab="log(nodes)", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, log(tapply(monolithic$time, monolithic$m, mean)),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, log(tapply(iterative$time, iterative$m, mean)),
...
#   axis(side = 1, at = m, labels = round(m, digits = 2), cex.lab = 2, cex.axis = 2)
#   legend("topleft", legend=legend, fill=fill_col, horiz=F, cex=1.5, inset=0.0125, 
#          bty="n")
#   
#   plot(m, tapply(monolithic$time, monolithic$m, mean),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(results$time), max(results$time)),
#        ylab="", xlab="observations", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, tapply(monolithic$time, monolithic$m, mean),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, tapply(iterative$time, iterative$m, mean),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, tapply(iterative$time, iterative$m, mean),
#          pch=16, cex=2, col=fill_col[1])
#   axis(side = 1, at = m, labels = m, cex.lab = 2, cex.axis = 2)
#   legend("topleft", legend=legend, fill=fill_col, horiz=F, cex=1.5, inset=0.0125, 
#          bty="n")
#   dev.off()
#   
#   pdf(paste0(imgdir, "init_time_mean.pdf"), family = "serif", width = 7, height = 7)
#   plot(m, log(tapply(monolithic$time_init, monolithic$m, mean)),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(log(results$time_init)), max(log(results$time_init))),
#        ylab="", xlab="log(nodes)", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, log(tapply(monolithic$time_init, monolithic$m, mean)),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, log(tapply(iterative$time_init, iterative$m, mean)),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, log(tapply(iterative$time_init, iterative$m, mean)),
#          pch=16, cex=2, col=fill_col[1])
#   # points(m, m-10,
...
#          bty="n")
#   
#   plot(m, tapply(monolithic$time_init, monolithic$m, mean),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(results$time_init), max(results$time_init)),
#        ylab="", xlab="observations", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, tapply(monolithic$time_init, monolithic$m, mean),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, tapply(iterative$time_init, iterative$m, mean),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, tapply(iterative$time_init, iterative$m, mean),
#          pch=16, cex=2, col=fill_col[1])
#   axis(side = 1, at = m, labels = m, cex.lab = 2, cex.axis = 2)
...
#   plot(m, log(tapply(monolithic$time_init, monolithic$m, median)),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(log(results$time_init)), max(log(results$time_init))),
#        ylab="", xlab="log(nodes)", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, log(tapply(monolithic$time_init, monolithic$m, median)),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, log(tapply(iterative$time_init, iterative$m, median)),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, log(tapply(iterative$time_init, iterative$m, median)),
#          pch=16, cex=2, col=fill_col[1])
#   # points(m, m-10,
...
#          bty="n")
#   
#   plot(m, tapply(monolithic$time_init, monolithic$m, median),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(results$time_init), max(results$time_init)),
#        ylab="", xlab="observations", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, tapply(monolithic$time_init, monolithic$m, median),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, tapply(iterative$time_init, iterative$m, median),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, tapply(iterative$time_init, iterative$m, median),
#          pch=16, cex=2, col=fill_col[1])
#   axis(side = 1, at = m, labels = m, cex.lab = 2, cex.axis = 2)
...
#   plot(m, log(tapply(monolithic$time_solve, monolithic$m, mean)),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(log(results$time_solve)), max(log(results$time_solve))),
#        ylab="", xlab="log(nodes)", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, log(tapply(monolithic$time_solve, monolithic$m, mean)),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, log(tapply(iterative$time_solve, iterative$m, mean)),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, log(tapply(iterative$time_solve, iterative$m, mean)),
#          pch=16, cex=2, col=fill_col[1])
#   # points(m, m-10,
...
#          bty="n")
#   
#   plot(m, tapply(monolithic$time_solve, monolithic$m, mean),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(results$time_solve), max(results$time_solve)),
#        ylab="", xlab="observations", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="solve time [s]")
#   points(m, tapply(monolithic$time_solve, monolithic$m, mean),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, tapply(iterative$time_solve, iterative$m, mean),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, tapply(iterative$time_solve, iterative$m, mean),
#          pch=16, cex=2, col=fill_col[1])
#   axis(side = 1, at = m, labels = m, cex.lab = 2, cex.axis = 2)
...
#   plot(m, log(tapply(monolithic$time_solve, monolithic$m, median)),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(log(results$time_solve)), max(log(results$time_solve))),
#        ylab="", xlab="log(nodes)", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="init time [s]")
#   points(m, log(tapply(monolithic$time_solve, monolithic$m, median)),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, log(tapply(iterative$time_solve, iterative$m, median)),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, log(tapply(iterative$time_solve, iterative$m, median)),
#          pch=16, cex=2, col=fill_col[1])
#   # points(m, m-10,
...
#          bty="n")
#   
#   plot(m, tapply(monolithic$time_solve, monolithic$m, median),
#        type="l", lty=2, lwd=4, col=fill_col[2], 
#        ylim= c(min(results$time_solve), max(results$time_solve)),
#        ylab="", xlab="observations", xaxt="n",
#        cex.lab = 2, cex.axis = 2, cex.main = 2,
#        main ="solve time [s]")
#   points(m, tapply(monolithic$time_solve, monolithic$m, median),
#          pch=16, cex=2, col=fill_col[2])
#   points(m, tapply(iterative$time_solve, iterative$m, median),
#          type="l", lty=2, lwd=4, col=fill_col[1])
#   points(m, tapply(iterative$time_solve, iterative$m, median),
#          pch=16, cex=2, col=fill_col[1])
#   axis(side = 1, at = m, labels = m, cex.lab = 2, cex.axis = 2)
