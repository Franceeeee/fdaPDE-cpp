...
data_dir = "../data/models/mixed_srpde/unit_square/same_locations/"
...
output_mono$beta
output_mono$b_i
output_mono_dir = paste0(data_dir,"output/monolithic/", n_obs, sim)
...
output_iter_dir = paste0(data_dir,"output/iterative/", n_obs, sim)
...

{
  ...
  plot_colorbar(f_1, coeff_lims = coeff_lims_1, colorscale = viridis,
                file = paste0(imgdir, "colorbar_f_1"))
...

{
  ...
  plot_colorbar(f_2, coeff_lims = coeff_lims_2, colorscale = viridis,
                file = paste0(imgdir, "colorbar_f_2"))
...
# ------------------------------------------------------------------------------
results = read.table(paste0(data_dir,"output/results.txt"), header = T) 
...
{ 
  ...
  mar_ = par("mar")
  mar_[2] = mar_[2] + 0.25
  pdf(paste0("imgs/time.pdf"), family = "serif", width = 7, height = 7)
  
  monolithic <- results[results$solution_policy == "monolithic", ]
  iterative <- results[results$solution_policy == "iterative", ]
  
  pdf(paste0("imgs/init_time_mean.pdf"), family = "serif", width = 7, height = 7)
  ...
  pdf(paste0("imgs/init_time_median.pdf"), family = "serif", width = 7, height = 7)
  ...
  pdf(paste0("imgs/solve_time_mean.pdf"), family = "serif", width = 7, height = 7)
  ...
  pdf(paste0("imgs/solve_time_median.pdf"), family = "serif", width = 7, height = 7)
